...
class DbConnect:
    ...
    def GetData(self, table: Incomplete | None = ..., fields: str = ..., where: str = ..., removeDups: int = ..., join: str = ..., transform: Incomplete | None = ..., randomAccess: int = ..., **kwargs): ...
    def GetDataCount(self, table: Incomplete | None = ..., where: str = ..., join: str = ..., **kwargs): ...
    def GetCursor(self): ...
