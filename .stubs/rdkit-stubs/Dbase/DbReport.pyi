...
class CDXImageTransformer:
    ...
    width: Incomplete
    verbose: Incomplete
    def __init__(self, smiCol, width: int = ..., verbose: int = ..., tempHandler: Incomplete | None = ...) -> None: ...
...
class CactvsImageTransformer:
    ...
    width: Incomplete
    verbose: Incomplete
    def __init__(self, smiCol, width: float = ..., verbose: int = ..., tempHandler: Incomplete | None = ...) -> None: ...
    def __call__(self, arg): ...
