...
def RunOnData(details, data, progressCallback: Incomplete | None = ..., saveIt: int = ..., setDescNames: int = ...): ...
def RunIt(details, progressCallback: Incomplete | None = ..., saveIt: int = ..., setDescNames: int = ...): ...
