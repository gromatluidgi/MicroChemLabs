...
def CalcNPossibleUsingMap(data, order, qBounds, nQBounds: Incomplete | None = ..., silent: bool = ...): ...
def WritePickledData(outName, data) -> None: ...
def TakeEnsemble(vect, ensembleIds, isDataVect: bool = ...): ...
def DBToData(dbName, tableName, user: str = ..., password: str = ..., dupCol: int = ..., what: str = ..., where: str = ..., join: str = ..., pickleCol: int = ..., pickleClass: Incomplete | None = ..., ensembleIds: Incomplete | None = ...): ...
...
def FilterData(inData, val, frac, col: int = ..., indicesToUse: Incomplete | None = ..., indicesOnly: int = ...): ...
def CountResults(inData, col: int = ..., bounds: Incomplete | None = ...): ...
def RandomizeActivities(dataSet, shuffle: int = ..., runDetails: Incomplete | None = ...) -> None: ...
