...
class MLDataSet:
    ...
    varNames: Incomplete
    ptNames: Incomplete
    def __init__(self, data, nVars: Incomplete | None = ..., nPts: Incomplete | None = ..., nPossibleVals: Incomplete | None = ..., qBounds: Incomplete | None = ..., varNames: Incomplete | None = ..., ptNames: Incomplete | None = ..., nResults: int = ...) -> None: ...
