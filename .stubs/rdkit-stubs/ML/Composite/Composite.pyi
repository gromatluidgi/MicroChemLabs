...
class Composite:
    ...
    def QuantizeActivity(self, example, activityQuant: Incomplete | None = ..., actCol: int = ...): ...
    def QuantizeExample(self, example, quantBounds: Incomplete | None = ...): ...
    def MakeHistogram(self): ...
    def CollectVotes(self, example, quantExample, appendExample: int = ..., onlyModels: Incomplete | None = ...): ...
    def ClassifyExample(self, example, threshold: int = ..., appendExample: int = ..., onlyModels: Incomplete | None = ...): ...
    def GetVoteDetails(self): ...
    def GetInputOrder(self): ...
    def SetInputOrder(self, colNames) -> None: ...
    def Grow(self, examples, attrs, nPossibleVals, buildDriver, pruner: Incomplete | None = ..., nTries: int = ..., pruneIt: int = ..., needsQuantization: int = ..., progressCallback: Incomplete | None = ..., **buildArgs) -> None: ...
