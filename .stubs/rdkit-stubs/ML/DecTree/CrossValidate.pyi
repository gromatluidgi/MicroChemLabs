...
def CrossValidationDriver(examples, attrs, nPossibleVals, holdOutFrac: float = ..., silent: int = ..., calcTotalError: int = ..., treeBuilder=..., lessGreedy: int = ..., startAt: Incomplete | None = ..., nQuantBounds=..., maxDepth: int = ..., **kwargs): ...
def TestRun() -> None: ...
