...
def GrowIt(details, composite, progressCallback: Incomplete | None = ..., saveIt: int = ..., setDescNames: int = ..., data: Incomplete | None = ...): ...
def GetComposites(details): ...
def BalanceComposite(details, composite, data1: Incomplete | None = ..., data2: Incomplete | None = ...): ...
