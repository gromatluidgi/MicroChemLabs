...
class CompoundDescriptorCalculator(Descriptors.DescriptorCalculator):
    ...
    def CalcSimpleDescriptorsForComposition(self, compos: str = ..., composList: Incomplete | None = ...): ...
    def CalcCompoundDescriptorsForComposition(self, compos: str = ..., composList: Incomplete | None = ..., propDict=...): ...
    ...
    def __init__(self, simpleList, compoundList: Incomplete | None = ..., dbName: Incomplete | None = ..., dbTable: str = ..., dbUser: str = ..., dbPassword: str = ...) -> None: ...
