...
def CrossValidationDriver(examples, attrs=..., nPossibleVals=..., holdOutFrac: float = ..., silent: int = ..., tolerance: float = ..., calcTotalError: int = ..., hiddenSizes: Incomplete | None = ..., **kwargs): ...
