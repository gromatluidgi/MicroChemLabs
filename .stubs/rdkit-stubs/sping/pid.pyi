...
class Font:
    def __init__(self, size: int = ..., bold: int = ..., italic: int = ..., underline: int = ..., face: Incomplete | None = ...) -> None: ...
...
class Canvas:
    ...
    def drawMultiLineString(self, s, x, y, font: Incomplete | None = ..., color: Incomplete | None = ..., angle: int = ..., **kwargs) -> None: ...
    ...
    def drawRect(self, x1, y1, x2, y2, edgeColor: Incomplete | None = ..., edgeWidth: Incomplete | None = ..., fillColor: Incomplete | None = ..., dash: Incomplete | None = ..., **kwargs) -> None: ...
