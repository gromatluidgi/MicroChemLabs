...
def drawString(canvas, s, x, y, font: Incomplete | None = ..., color: Incomplete | None = ..., angle: int = ...) -> None: ...
def test1() -> None: ...
def test2() -> None: ...
def allTagCombos(canvas, x, y, font: Incomplete | None = ..., color: Incomplete | None = ..., angle: int = ...): ...
