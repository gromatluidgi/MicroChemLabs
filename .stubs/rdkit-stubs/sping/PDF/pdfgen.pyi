...
class Canvas:
    ...
    def save(self, filename: Incomplete | None = ..., fileobj: Incomplete | None = ...) -> None: ...
    ...
    def wedge(self, x1, y1, x2, y2, startAng, extent, stroke: int = ..., fill: int = ...) -> None: ...
    def circle(self, x_cen, y_cen, r, stroke: int = ..., fill: int = ...) -> None: ...
    def roundRect(self, x, y, width, height, radius, stroke: int = ..., fill: int = ...) -> None: ...
    ...
    def drawInlineImage(self, image, x, y, width: Incomplete | None = ..., height: Incomplete | None = ...) -> None: ...
    def readJPEGInfo(self, image): ...
    def setPageCompression(self, onoff: int = ...) -> None: ...
    def setPageTransition(self, effectname: Incomplete | None = ..., duration: int = ..., direction: int = ..., dimension: str = ..., motion: str = ...) -> None: ...
