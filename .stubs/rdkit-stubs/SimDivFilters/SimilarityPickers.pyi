...
class TopNOverallPicker(GenericPicker):
    ...
    def __init__(self, numToPick: int = ..., probeFps: Incomplete | None = ..., dataSet: Incomplete | None = ..., simMetric=...) -> None: ...
    def MakePicks(self, force: bool = ...) -> None: ...
...
class SpreadPicker(GenericPicker):
    ...
    def __init__(self, numToPick: int = ..., probeFps: Incomplete | None = ..., dataSet: Incomplete | None = ..., simMetric=..., expectPickles: bool = ..., onlyNames: bool = ...) -> None: ...
