...
def MergeFeatPoints(fm, mergeMetric=..., mergeTol: float = ..., dirMergeMode=..., mergeMethod=..., compatFunc=...): ...
def CombineFeatMaps(fm1, fm2, mergeMetric=..., mergeTol: float = ..., dirMergeMode=...): ...
