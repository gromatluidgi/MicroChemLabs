...
class FeatMap:
    ...
    params: Incomplete
    def __init__(self, params: Incomplete | None = ..., feats: Incomplete | None = ..., weights: Incomplete | None = ...) -> None: ...
    ...
    def ScoreFeats(self, featsToScore, mapScoreVect: Incomplete | None = ..., featsScoreVect: Incomplete | None = ..., featsToFeatMapIdx: Incomplete | None = ...): ...
