...
def GetSimilarityMapFromWeights(mol, weights, colorMap: Incomplete | None = ..., scale: int = ..., size=..., sigma: Incomplete | None = ..., coordScale: float = ..., step: float = ..., colors: str = ..., contourLines: int = ..., alpha: float = ..., draw2d: Incomplete | None = ..., **kwargs): ...
