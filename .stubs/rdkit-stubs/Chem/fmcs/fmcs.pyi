...
def all_subgraph_extensions(enumeration_mol, subgraph, visited_bond_indices, internal_bonds, external_edges) -> Generator[Incomplete, None, None]: ...
...
class CachingTargetsMatcher(dict):
    ...
    def __init__(self, targets, required_match_count: Incomplete | None = ...) -> None: ...
...
def compute_mcs(fragmented_mols, typed_mols, minNumAtoms, threshold_count: Incomplete | None = ..., maximize=..., completeRingsOnly=..., timeout=..., timer: Incomplete | None = ..., verbose: bool = ..., verboseDelay: float = ...): ...
...
def fmcs(mols, minNumAtoms: int = ..., maximize=..., atomCompare=..., bondCompare=..., threshold: float = ..., matchValences=..., ringMatchesRingOnly: bool = ..., completeRingsOnly: bool = ..., timeout=..., times: Incomplete | None = ..., verbose: bool = ..., verboseDelay: float = ...): ...
