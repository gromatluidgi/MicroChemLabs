...
def GetMoreTerminalPoints(shape, pts, winRad, maxGridVal, targetNumber: int = ...) -> None: ...
def FindFarthestGridPoint(shape, loc, winRad, maxGridVal): ...
def ExpandTerminalPts(shape, pts, winRad, maxGridVal: float = ..., targetNumPts: int = ...) -> None: ...
def AppendSkeletonPoints(shapeGrid, termPts, winRad, stepDist, maxGridVal: int = ..., maxDistC: float = ..., distTol: float = ..., symFactor: float = ..., verbose: bool = ...): ...
