...
class FGHierarchyNode:
    ...
    def __init__(self, name, patt, smarts: str = ..., label: str = ..., rxnSmarts: str = ..., parent: Incomplete | None = ...) -> None: ...
...
def BuildFuncGroupHierarchy(fileNm: Incomplete | None = ..., data: Incomplete | None = ..., force: bool = ...): ...
