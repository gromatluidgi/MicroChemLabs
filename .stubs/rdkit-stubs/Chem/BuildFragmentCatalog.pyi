...
def BuildCatalog(suppl, maxPts: int = ..., groupFileName: Incomplete | None = ..., minPath: int = ..., maxPath: int = ..., reportFreq: int = ...): ...
def ScoreMolecules(suppl, catalog, maxPts: int = ..., actName: str = ..., acts: Incomplete | None = ..., nActs: int = ..., reportFreq: int = ...): ...
def ScoreFromLists(bitLists, suppl, catalog, maxPts: int = ..., actName: str = ..., acts: Incomplete | None = ..., nActs: int = ..., reportFreq: int = ...): ...
def CalcGains(suppl, catalog, topN: int = ..., actName: str = ..., acts: Incomplete | None = ..., nActs: int = ..., reportFreq: int = ..., biasList: Incomplete | None = ..., collectFps: int = ...): ...
def CalcGainsFromFps(suppl, fps, topN: int = ..., actName: str = ..., acts: Incomplete | None = ..., nActs: int = ..., reportFreq: int = ..., biasList: Incomplete | None = ...): ...
