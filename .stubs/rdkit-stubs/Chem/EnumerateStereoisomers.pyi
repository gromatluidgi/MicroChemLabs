...
class StereoEnumerationOptions:
    ...
    rand: Incomplete
    unique: Incomplete
    def __init__(self, tryEmbedding: bool = ..., onlyUnassigned: bool = ..., maxIsomers: int = ..., rand: Incomplete | None = ..., unique: bool = ..., onlyStereoGroups: bool = ...) -> None: ...
...
def EnumerateStereoisomers(m, options=..., verbose: bool = ...) -> Generator[Incomplete, None, None]: ...
